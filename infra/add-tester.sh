...
# Commit: install Caddyfile, save plaintext, reload Caddy. Mode 640 root:caddy so
# the bcrypt tester hashes in it are not world-readable (only root + the caddy user).
